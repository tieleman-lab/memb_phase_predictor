...
# tt = mpp.Predictor('cg_good.gro', 'cg.xtc', begin=-1000, skip=1, b_type='orthorombic')
tt = mpp.Predictor('DPPC_DOPC_280K.gro', 'DPPC_DOPC_280K.xtc', begin=-1000, skip=1, b_type='triclinic')
